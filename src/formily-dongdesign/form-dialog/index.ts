...
import { JdDialog, JdButton } from '@jd/jdesign-vue'
import type {
  JdDialog as JdDialogProps,
  JdButton as JdButtonProps,
} from '@jd/jdesign-vue'
import {
  Component,
  VNode,
...
type IFormDialogProps = Omit<typeof JdDialogProps, 'title'> & {
  title?: DialogTitle
  footer?: null | Component | VNode | (() => VNode)
  cancelText?: string | Component | VNode | (() => VNode)
  cancelButtonProps?: typeof JdButtonProps
  okText?: string | Component | VNode | (() => VNode)
  okButtonProps?: typeof JdButtonProps
  ...
  const render = (visible = true, resolve?: () => any, reject?: () => any) => {
    if (!env.instance) {
      const ComponentConstructor = observer(
        defineComponent({
          props: { dialogProps: Object as PropType<typeof JdDialogProps> },
          data() {
            return {
              visible: false,
            }
