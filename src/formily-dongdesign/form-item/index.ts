...
import { JdTooltip, JdIcon } from '@jd/jdesign-vue'
...
const ICON_MAP = {
  info: () => h(JdIcon, {}, { default: () => h(InfoCircle, {}, {}) }),
  error: () => h(JdIcon, {}, { default: () => h(CloseCircle, {}, {}) }),
  success: () => h(JdIcon, {}, { default: () => h(CheckCircle, {}, {}) }),
  warning: () => h(JdIcon, {}, { default: () => h(ExclamationCircle, {}, {}) }),
}
  ...
  setup(props, { slots }) {
    ...
    return () => {
      ...
      const {
        ...
        tooltip,
        labelStyle = {},
        labelWrap = deepLayout.labelWrap ?? true,
