...
import type { ButtonProps as JdButtonProps } from '@jd/jdesign-vue'
import { JdButton } from '@jd/jdesign-vue'
import type { Schema } from '@formily/json-schema'
// import { HandleDirective } from 'vue-slicksort'
import { Trash, ArrowUp, ArrowDown, Check } from '@jd/jdesign-icons-vue'

import { stylePrefix } from '../__builtins__/configs'
import { composeExport } from '../__builtins__/shared'

export interface IArrayBaseAdditionProps extends JdButtonProps {
  title?: string
  method?: 'push' | 'unshift'
  defaultValue?: any
}
